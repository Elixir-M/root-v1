        ...
        <footer className="bg-black w-full">
          <div className="w-full flex md:flex-row flex-col justify-around items-start pt-10 px-10">
            ...
            <div className="p-5 flex flex-col items-start">
              <div className="flex flex-col space-y-4">
                <p className="text-white font-bold text-3xl">
                  <h4 className="text-5xl font-bold text-purple-600 glow-animation">
                    Elixir
                  </h4>
                </p>
            ...
            <div className="p-5 flex flex-col items-center">
              <p className="text-white font-bold text-2xl py-4 text-center w-full">
                Services
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto px-4">
                {offices.map((office, index) => (
                  <div key={index} className="p-4 text-sm">
                    ...
                    {office.address2 && (
                      <p className="mb-1">{office.address2}</p>
                    )}
                    <div className="flex flex-col gap-1">
                      <p className="flex items-center">
                        ...
                        <a
                          ...
                          className="text-gray-300 hover:text-blue-600 transition-all duration-200"
                        >
                          {office.phone1}
                        </a>
                      </p>
