...
const servicesData = {
  ...
  blockchain: {
    ...
    tagline: "Beyond Boundaries: Smarter, Safer Blockchain Solutions.",
    videoUrl:
      "https://videos.pexels.com/video-files/4389377/4389377-uhd_2732_1440_30fps.mp4",
    gradientshade: "#000000",
    cards: [
      {
        imgSrc: "/assets/img/SmartContracts.avif",
      ...
      },
      {
        ...
        features: [
          "Apps that run on blockchain networks without central servers.",
          "Enable censorship resistance and data ownership.",
          "Backbone of Web3 ecosystems and DeFi.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Eliminates intermediaries in lending, trading, and saving.",
          "Built on blockchains like Ethereum, using smart contracts.",
          "Access global financial services via crypto wallets.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Tokenized digital assets that are unique and verifiable.",
          "Used in art, gaming, identity, and collectibles.",
          "Empowers creators with verifiable ownership.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Blockchain-native organizations governed by community votes.",
          "Transparent decision-making via smart contracts.",
          "Used for protocol governance, funding, and more.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          ...
          "Hosts DeFi, NFTs, DAOs, and dApps.",
          "Supports Solidity and scaling with rollups.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          ...
          "Supports private transactions and modular architecture.",
          "Ideal for supply chain, finance, and healthcare.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          ...
          "Built for dApps, NFTs, and DeFi at scale.",
      ...
      },
      {
        ...
        features: [
          ...
          "Combines Proof-of-Stake and zero-knowledge tech.",
          "Supports fast and cost-effective transactions.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Proves truth without revealing sensitive information.",
          "Enhances blockchain scalability and privacy.",
          "Used in ZK-rollups, identity, and voting.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Batch hundreds of transactions off-chain.",
          "Use validity proofs to ensure correctness.",
          "Reduce gas costs while maintaining security.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Primary language for EVM-based chains like Ethereum.",
          "Object-oriented and statically typed.",
          "Enables development of robust blockchain apps.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Used in high-performance chains like Solana and Polkadot.",
          "Memory-safe with no garbage collection.",
          "Ideal for scalable, secure blockchain development.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Feed smart contracts with off-chain data.",
          "Enable use cases like DeFi price feeds and insurance.",
          "Maintain data integrity via decentralized networks.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
      {
        ...
        features: [
          "Peer-to-peer storage for files, websites, and dApps.",
          "Content-addressed instead of location-based.",
          "Often used with NFTs and blockchain apps.",
        ],
        deployedLink: "https://your-deployed-site.com",
      },
    ],
    serviceSection: {
      heading:
        "Blockchain technology is reshaping industries by offering security, transparency, and decentralization.",
      description: [
        "Smart Contract Development: Automate processes without intermediaries.",
        "Decentralized Applications (DApps): Secure and efficient blockchain applications.",
        "Token & Cryptocurrency Development: Secure, scalable digital assets.",
  ...
  mobileAppDev: {
    ...
    serviceSection: {
      heading:
        "Innovative Mobile App Solutions Tailored To Your Business Needs",
      description: [
  ...
  webDev: {
    ...
    cards: [
      // --- Highest Demand Tier ---
      {
        ...
        features: [
          "Building dynamic, component-based UIs with React.",
          "Leveraging Next.js for SSR, SSG, API routes, and performance optimization.",
          "Managing complex application state effectively (Redux Toolkit, Zustand).",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Building scalable backend services using Node.js (Express/NestJS) or Python (Django/FastAPI).",
          "Developing efficient and reliable RESTful or GraphQL APIs.",
          "Expertise in both JavaScript/TypeScript and Python ecosystems for backend logic.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Mastery of HTML5, CSS3, and modern JavaScript (ESNext).",
          "Utilizing TypeScript for enhanced code quality, maintainability, and scalability.",
          "Building accessible, responsive, and interactive user interfaces from the ground up.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Deploying applications on major cloud platforms (AWS, Azure, GCP) or modern frontend platforms (Vercel, Netlify).",
          "Implementing CI/CD pipelines for automated testing and deployment.",
          "Utilizing Docker & Kubernetes for containerization and orchestration, ensuring scalability and reliability.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      // --- High/Medium Demand Tier ---
      {
        ...
        features: [
          "Creating robust RESTful APIs following standard conventions.",
          "Developing efficient GraphQL APIs allowing clients to request specific data.",
          "Ensuring secure, well-documented, and performant API endpoints.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Working with powerful relational databases like PostgreSQL.",
          "Utilizing flexible NoSQL document databases like MongoDB.",
          "Implementing high-performance caching and data structures with Redis.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Developing and customizing traditional WordPress sites.",
          "Implementing modern Headless CMS solutions (Strapi, Contentful, Sanity) for decoupled architectures.",
          "Integrating CMS platforms with various frontend frameworks.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Rapid UI development using utility-first frameworks like Tailwind CSS.",
          "Component-scoped styling with CSS-in-JS libraries (Styled Components, Emotion).",
          "Focus on responsive design, theming, and maintainable CSS architecture.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      // --- Medium/Lower Demand Tier (but important) ---
      {
        ...
        features: [
          "Building large-scale enterprise applications with Angular.",
          "Developing progressive and incrementally adoptable UIs with Vue.js.",
          "Creating highly performant applications with the Svelte/SvelteKit compiler approach.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Unit and integration testing using frameworks like Jest or Vitest.",
          "End-to-end testing to validate user flows with Cypress or Playwright.",
          "Implementing testing best practices for robust and maintainable codebases.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Leveraging next-gen build tools like Vite for rapid development.",
          "Configuring and optimizing complex build pipelines with Webpack.",
          "Focusing on bundle size reduction, code splitting, and performance optimization.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Developing Progressive Web Apps (PWAs) for app-like experiences.",
          "Integrating WebAssembly (Wasm) for performance-critical tasks.",
          "Utilizing Serverless Functions for scalable, event-driven backend logic.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
    ],
  ...
  aiml: {
    ...
    cards: [
      // --- Highest Demand Tier ---
      {
        ...
        features: [
          "Leveraging Transformer architecture (BERT, GPT, T5) via platforms like Hugging Face.",
          "Developing solutions using Large Language Models (LLMs) for tasks like text generation, summarization, Q&A, sentiment analysis.",
          "Building custom NLP pipelines using libraries like spaCy, NLTK.",
      ...
      },
      {
        ...
        features: [
          "Utilizing LLMs for creative text generation, copywriting, and code assistance.",
          "Implementing state-of-the-art image generation with Diffusion Models (e.g., Stable Diffusion).",
          "Exploring applications in synthetic data generation, creative arts, and design.",
          "Fine-tuning generative models for specific domains and styles.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Implementing robust MLOps practices for model lifecycle management (training, versioning, deployment, monitoring).",
          "Utilizing Cloud AI Platforms (AWS SageMaker, Azure ML, Vertex AI) for managed services.",
          "Handling large datasets with distributed computing (Apache Spark/MLlib).",
          "Leveraging Vector Databases (Pinecone, Chroma, Weaviate) for efficient semantic search and RAG.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Expertise in Python for AI/ML development.",
          "Efficient numerical computation with NumPy.",
          "Data manipulation, cleaning, and analysis using Pandas DataFrames.",
          "Foundation for nearly all AI/ML projects.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      // --- High/Medium Demand Tier ---
      {
        ...
        features: [
          "Building classification, regression, and time-series models using Scikit-learn.",
          "Developing predictive analytics solutions for forecasting, risk assessment, churn prediction.",
          "Creating personalized recommender systems (collaborative/content-based filtering).",
          "Applying classical ML techniques for tangible business insights.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Developing solutions for image classification, object detection (e.g., YOLO), segmentation.",
          "Utilizing Convolutional Neural Networks (CNNs) for deep learning on images/videos.",
          "Applying classical CV techniques with libraries like OpenCV.",
          "Expertise in processing and analyzing visual information.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Proficiency in TensorFlow for production-grade deep learning.",
          "Expertise in PyTorch for research and flexible model development.",
          "Utilizing Keras API for rapid prototyping and user-friendly network building.",
      ...
      // --- Medium/Lower Demand Tier (but important/specialized) ---
      {
        ...
        features: [
          "Implementing practices for fairness, transparency, and accountability in AI.",
          "Utilizing Explainable AI (XAI) techniques to understand model decisions.",
          "Addressing bias detection and mitigation.",
          "Adhering to emerging AI regulations and ethical guidelines.",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
      {
        ...
        features: [
          "Developing RL agents for optimization, control systems, and game playing.",
          "Utilizing libraries like OpenAI Gym, Stable Baselines3, RLlib.",
          "Applying RL techniques to complex sequential decision problems.",
          "Expertise in various RL algorithms (Q-learning, PPO, etc.).",
        ],
        deployedLink: "https://your-deployed-site.com", // Placeholder
      },
    ],
    serviceSection: {
      heading:
        "Leveraging AI & ML for Data-Driven Decisions and Intelligent Automation",
      description: [
  ...
  cybersec: {
    ...
    serviceSection: {
      heading:
        "Comprehensive Cybersecurity Services to Mitigate Risks and Protect Your Business",
      description: [
  ...
  cloudsolutions: {
    // Corrected: Unquoted top-level key
